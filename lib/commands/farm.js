        ...
        farm.inventory.crops.forEach(crop => {
            ...
            switch(plantInfo.tier) {
                case 'common':
                    ...
                    break;
                case 'rare':
                    sellMultiplier = 0.80; // 80% dari base price
                    break;
                case 'epic':
                    sellMultiplier = 0.75; // 75% dari base price
                    break;
                case 'legendary':
                    sellMultiplier = 0.65; // 65% dari base price
                    break;
                case 'mythical':
                    sellMultiplier = 0.55; // 55% dari base price
                    break;
                case 'divine':
                    sellMultiplier = 0.45; // 45% dari base price
                    break;
                default:
                    sellMultiplier = 0.6;
            }
