...
const openai = new OpenAI({
    apiKey: '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'
});
...
async function seaHandler(sock, msg) {
    try {
        ...
        // Get response from OpenAI using updated API
