...
const FISH_DATA = {
    ...
    // Legendary (1%)
    legendary: {
        pausBiru: { name: "Paus Biru", emoji: "🐋", price: 1000 },
        hiuPaus: { name: "Hiu Paus", emoji: "🦈", price: 1100 },
        arapaima: { name: "Arapaima", emoji: "🐋", price: 1200 },
        megalodon: { name: "Megalodon", emoji: "🦈", price: 13000 },
        coelacanth: { name: "Coelacanth", emoji: "🐋", price: 15000 }
    }
};
